...
<head>
    ...
    <meta name="description" content="{{ trim((string) $__env->yieldContent('meta_description')) !== '' ? $__env->yieldContent('meta_description') : ($seoDescription ?? 'Professional cleaning services.') }}">
