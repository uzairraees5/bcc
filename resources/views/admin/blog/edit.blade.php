            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    @if($blogPost->image_path)
                        <div class="mt-2">
                            <img src="{{ asset('storage/' . $blogPost->image_path) }}" alt="Current image" style="max-height: 150px;">
                        </div>
                    @endif
                </div>
                <div class="col-12">
                    <label class="form-label">Image Alt Text</label>
                    <input type="text" name="image_alt_text" class="form-control" value="{{ old('image_alt_text', $blogPost->image_alt_text) }}">
                </div>
                <div class="col-12">
                ...
                <div class="col-12">
                    ...
                    <textarea name="content" class="form-control" rows="12" id="blog-editor">{{ old('content', $blogPost->content) }}</textarea>
                </div>
            </div>
